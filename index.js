...
ch.send(`⭐ ${msg.author.username} gained 1 XP`);
...
`☕ Java — My beloved, My heart, My soul ❤️
...
ch.send(`💡 Suggestion by ${interaction.user.username}
